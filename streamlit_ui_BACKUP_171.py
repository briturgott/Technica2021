...
st.dataframe('background-color: yellow', pretty_data.assign(pretty_data='').set_index('pretty_data'), width=1024, height=1024)

>>>>>>> 4ba2c230c6e80e9da72c0e8704fddcfcf5b9db12
post_list.close()